...
The logs generated by running scenario 6 are analyzed to calculate the [standard deviation of the GPS and IMU](config/06_SensorNoise.txt) sensor measurements. These values are then used to update the sensor noise parameters:
```
